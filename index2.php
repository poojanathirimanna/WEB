...
<header class="bg-gray-800 text-white p-4 flex items-center justify-between shadow-md">
    ...
    <nav class="space-x-6 flex-1 text-center">
        <a href="../WEB/user/services.php" class="hover:text-[#F7941D] transition duration-300 mx-4">Services</a>
        <a href="../WEB/user/contact.php" class="hover:text-[#F7941D] transition duration-300 mx-4">Contact</a>
    </nav>
