...
// Define the category ID for RAM
$category_id = 2;  // Replace with the actual category ID for RAM

// Fetch products from the database that belong to the 'RAM' category
