...
// Define the category ID for Graphic Cards
$category_id = 3;  // Replace with the actual category ID for Graphic Cards

// Fetch products from the database that belong to the 'Graphic Cards' category
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 justify-center px-4">
                    ...
                    <?php while ($product = $result->fetch_assoc()): ?>
                        <div class="bg-gray-800 text-white rounded-lg shadow-lg p-4 transition duration-300 hover:bg-[#F7941D] hover:scale-105">
                            ...
                            <p class="text-[#F7941D]">Graphic Cards</p>
